/**
 * useWarrantyCard.ts: Hook για τη διαχείριση ενεργειών σε μια μεμονωμένη κάρτα εγγύησης.
 * Διαχειρίζεται αλλαγές status, πληρωμών, διαγραφές και δικαιώματα χρήστη.
 */
