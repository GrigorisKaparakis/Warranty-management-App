/**
 * useFilteredEntries.ts: Hook για το προχωρημένο φιλτράρισμα και την αναζήτηση εγγυήσεων.
 * Υποστηρίζει Fuzzy Search (μέσω Fuse.js), φιλτράρισμα βάσει κατάστασης, ημερομηνίας και εταιρείας.
 */
