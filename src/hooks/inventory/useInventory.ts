/**
 * useInventory.ts
 * Hook για τη διαχείριση της λογικής της λίστας εγγυήσεων (Inventory).
 * 
 * Αρμοδιότητες:
 * - Φιλτράρισμα, ταξινόμηση και σελιδοποίηση.
 * - Διαχείριση "Load More" από τον Firestore.
 * - Έλεγχος δικαιωμάτων επεξεργασίας.
 */
