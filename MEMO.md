...
*   **`WarrantyPaymentsView.tsx`**: Διαχείριση και στατιστικά πληρωμών εγγυήσεων.
...
### 📅 ΕΚΔΟΣΗ 1.2.0 (ΥΛΟΠΟΙΗΘΗΚΕ)
1.  **Warranty Payments**: Νέα ενότητα για την παρακολούθηση εσόδων ανά εγγύηση.
2.  **Excel Export**: Δυνατότητα εξαγωγής των πληρωμών σε αρχείο `.xlsx` για λογιστική χρήση.
3.  **Revenue Stats**: Δυναμικά γραφήματα εσόδων ανά εταιρεία και μήνα.

### 📅 ΕΚΔΟΣΗ 1.2.1 (ΣΧΕΔΙΑΣΜΟΣ)
